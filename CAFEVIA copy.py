...
# =========================================================================================================
        ...
        def TableBookMenu():
            ...
            # # Row 2
            # draw_table_with_chairs(canvas, 70, 290, 150, 90, {"top": 3, "bottom": 3, "left": 1, "right": 1}, 1)   # Table 1
            # draw_table_with_chairs(canvas, 330, 290, 110, 90, {"top": 2, "bottom": 2, "left": 2, "right": 2}, 2)  # Table 2
            # draw_table_with_chairs(canvas, 560, 290, 110, 90, {"top": 2, "bottom": 2, "left": 1, "right": 1}, 3)  # Table 3
            # draw_table_with_chairs(canvas, 790, 290, 150, 90, {"top": 3, "bottom": 3, "left": 2, "right": 2}, 4)  # Table 4
            # draw_table_with_chairs(canvas, 1050, 290, 140, 90, {"top": 3, "bottom": 3, "left": 1, "right": 1}, 5) # Table 5

            # # Row 3
            # draw_table_with_chairs(canvas, 70, 530, 110, 90, {"top": 2, "bottom": 2, "left": 1, "right": 1}, 1)   # Table 1
            # draw_table_with_chairs(canvas, 290, 530, 180, 90, {"top": 4, "bottom": 4, "left": 2, "right": 2}, 2)  # Table 2
            # draw_table_with_chairs(canvas, 580, 530, 110, 90, {"top": 2, "bottom": 2, "left": 1, "right": 1}, 3)  # Table 3
            # draw_table_with_chairs(canvas, 810, 530, 150, 90, {"top": 3, "bottom": 3, "left": 2, "right": 2}, 4)  # Table 4
            # draw_table_with_chairs(canvas, 1080, 530, 110, 90, {"top": 2, "bottom": 2, "left": 1, "right": 1}, 5) # Table 5
            ...
            def on_table_click(table_number):
                ...
                # Fetch updated status and change button color immediately
            ...
            def draw_table_with_chairs(canvas, relx, rely, table_width, table_height, chair_config, table_number):
                ...
                chair_color = price_color if status == "available" else "#CECECE" #grey color  # Add chair color logic
                ...
                for i in range(chair_config["top"]):
                    chair_x = x + (i + 0.5) * (table_width / chair_config["top"]) - (chair_size / 2)
                    chair_y = y - chair_size - chair_spacing
                    canvas.create_rectangle(chair_x, chair_y, chair_x + chair_size, chair_y + chair_size, fill=chair_color) #remove border: outline=""

                # Draw chairs on the bottom side
                for i in range(chair_config["bottom"]):
                    chair_x = x + (i + 0.5) * (table_width / chair_config["bottom"]) - (chair_size / 2)
                    chair_y = y + table_height + chair_spacing
                    canvas.create_rectangle(chair_x, chair_y, chair_x + chair_size, chair_y + chair_size, fill=chair_color)
