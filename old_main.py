...
menu_bar = Frame(bg="#27150C",height=100)
...
# logo
menu_logo = Label(menu_bar, text="CAFEVIA", bg="#232323", fg="#000")
menu_logo.place(relx=0.2, rely=0.05)
menu_logo.config(bg="#27150C", fg="#E7E0D6", font=("century gothic bold", 20))

# dashboard button
menu_dashboard = Button(menu_bar, text='Dashboard', bg='#E7E0D6', fg='#000', command=dashboard, font=("century gothic", 11), bd=0, cursor="hand2")
menu_dashboard.place(relx=0.1, rely=0.15, relwidth=0.8, relheight=0.05)

# playlist button
menu_playlist = Button(menu_bar, text='Playlist', bg='#E7E0D6', fg='#000', command=playlist, font=("Arsenal", 11), bd=0, cursor="hand2")
menu_playlist.place(relx=0.1, rely=0.31, relwidth=0.8, relheight=0.05)

# artist button
menu_artist = Button(menu_bar, text='Artist', bg='#E7E0D6', fg='#000', command=artist, font=("Arsenal", 11), bd=0, cursor="hand2")
menu_artist.place(relx=0.1, rely=0.23, relwidth=0.8, relheight=0.05)

# user button
menu_user = Button(menu_bar, text='User', bg='#E7E0D6', fg='#000', command=user, font=("Arsenal", 11), bd=0, cursor="hand2")
menu_user.place(relx=0.1, rely=0.39, relwidth=0.8, relheight=0.05)

# category button
menu_category = Button(menu_bar, text='Category', bg='#E7E0D6', fg='#000', command=category, font=("Arsenal", 11), bd=0, cursor="hand2")
menu_category.place(relx=0.1, rely=0.47, relwidth=0.8, relheight=0.05)

# logout button
menu_logout = Button(menu_bar, text='Logout', bg='#E7E0D6', fg='#000', command=logout, font=("Arsenal", 11), bd=0, cursor="hand2")
menu_logout.place(relx=0.1, rely=0.9, relwidth=0.8, relheight=0.05)

# =====================ProfileNavbar========================================================

navbar = Frame(bg="#27150C")
navbar.place(relx=0.18, rely=0, relwidth=0.82, relheight=0.06)

# profile button
profile_btn = Button(navbar, text='V', bg='#E7E0D6', fg='#000', command=logout, font=("Arsenal", 11, "bold"), bd=0, cursor="hand2")
profile_btn.place(relx=0.97, rely=0.25, relwidth=0.02, relheight=0.5)

# profile-name button
profile_name_btn = Label(navbar, text='Vasu', bg='#27150C', fg='#E7E0D6', font=("Arsenal", 10, "bold"), bd=0, cursor="hand2")
profile_name_btn.place(relx=0.93, rely=0.25, relwidth=0.04, relheight=0.5)

# # =====================ContentSection========================================================

# cnt_sec = Frame(bg="#E7E0D6")
...
# panel = Label(root, image=img,height=180,width=250)
# panel.image = img
