...
# =================================================================
            ...
            for product_details in products:
                ...
                # Category
                ProductCategoryLabel = Label(ProductDtlCard, text=product_details[1], bg=sidecart_color, fg=primary_color, font=("century gothic", 8), anchor="w")
                ...
                # Price
                ProductPriceLabel = Label(ProductDtlCard, text=f"₹ {product_details[3]}", bg=price_color, fg=sidecart_color, font=("century gothic bold", 15))
                ProductPriceLabel.place(relx=0.05, rely=0.78, relwidth=0.4, relheight=0.17)
